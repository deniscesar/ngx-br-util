...
import { CurrencyMaskConfig, CURRENCY_MASK_CONFIG } from "./dinheiro.mask.config";
import {InputHandler} from "./input.handler";


export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => DinheiroMaskDirective),
  multi: true
};
...
export class DinheiroMaskDirective implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
